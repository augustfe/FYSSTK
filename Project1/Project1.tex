...
\begin{figure}[htbp]
    ...
    \caption{MSE for ordinary least squares of polynomial degree up to 5.}
    \label{fig:OLS5MSE}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{$R^2$ for ordinary least squares of polynomial degree up to 5.}
    \label{fig:OLS5R2}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Bias variance tradeoff for OLS with 400 points instead of 1600 for polynomial degree up to 15. Resampling with bootstrap.}
