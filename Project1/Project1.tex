...
\begin{figure}[h]
    % \includegraphics[width=95mm]{lasso_ridge_contour.png}
    \centering
    \includegraphics[width=\textwidth]{FrankesFunction.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth*2/3]{OLS_5_betas.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth*2/3]{OLS_5_MSE.png}
    \caption{MSE for OLS up to polynomial degree of 5}
    \label{fig:OLS5MSE}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth*2/3]{OLS_5_R2.png}
    \caption{$R^2$ for OLS up to polynomial degree of 5}
    \label{fig:OLS5R2}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth*2/3]{Bias Variance Tradeoff OLS.png}
    \caption{Bias variance tradeoff for OLS up to polynomial degree of 13.}
