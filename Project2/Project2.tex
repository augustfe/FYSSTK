...
\begin{figure}[H]%
    ...
    \\% 
    \subfloat[\centering ReLU]{{\includegraphics[width=5.5cm]{Project2/figures/franke/momentum/relu_validation_error_heatmap.pdf} }}%
    \qquad
    \subfloat[\centering LReLU]{{\includegraphics[width=5.5cm]{Project2/figures/franke/momentum/lrelu_validation_error_heatmap.pdf} }}%
