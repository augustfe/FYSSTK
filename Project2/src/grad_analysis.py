import numpy as np
from Schedules import Scheduler, Constant, Momentum, Adagrad, AdagradMomentum, Adam
from Gradients import Gradients
from plotutils import plotThetas, PlotPredictionPerVariable, PlotErrorPerVariable
