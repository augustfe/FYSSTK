...
\begin{figure}[H]%
    \centering
    \subfloat[\centering $\sigma(x)$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/sigmoid.pdf} }}%
    \qquad
    \subfloat[\centering $\tanh(x)$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/tanh.pdf} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering $\operatorname{ReLU}(x)$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/relu.pdf} }}%
    \qquad
    \subfloat[\centering $\operatorname{LReLU}(x)$, with $\gamma = 0.1$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/leaky_relu.pdf} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering $\operatorname{Swish}(x)$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/silu.pdf} }}%
    \qquad
    \subfloat[\centering $\operatorname{ELU}(x)$]{{\includegraphics[width=5.5cm]{Project3/figures/activators/elu.pdf} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Predicted solution]
    {\includegraphics[width=5.5cm]{Project3/figures/ReLU/-4_[100, 25]_dnn.pdf}}%
    \qquad
    \subfloat[\centering Absolute difference between DNN and analytical solution]
    {\includegraphics[width=5.5cm]{Project3/figures/ReLU/-4_[100, 25]_diff.pdf}}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Time step $t = 0.5$]{\includegraphics[width=8cm]{Project3/figures/ReLU/-4_[100, 25]_timestep_0.5.pdf}}
    \qquad
    \subfloat[\centering Time step $t = 1$]{\includegraphics[width=8cm]{Project3/figures/ReLU/-4_[100, 25]_timestep_1.0.pdf}}
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Predicted solution]
    {\includegraphics[width=5.5cm]{Project3/figures/Sigmoid/-2_[100, 25]_dnn.pdf}}%
    \qquad
    \subfloat[\centering Absolute difference between DNN and analytical solution]
    {\includegraphics[width=5.5cm]{Project3/figures/Sigmoid/-2_[100, 25]_diff.pdf}}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Time step $t = 0.5$]{\includegraphics[width=8cm]{Project3/figures/Sigmoid/-2_[100, 25]_timestep_0.5.pdf}}
    \qquad
    \subfloat[\centering Time step $t = 1$]{\includegraphics[width=8cm]{Project3/figures/Sigmoid/-2_[100, 25]_timestep_1.0.pdf}}
...
\begin{figure}[H]%
    \centering
    \subfloat[\centering Predicted solution]
    {\includegraphics[width=5.5cm]{Project3/figures/Tanh/-2_[100, 25]_dnn.pdf}}%
    \qquad
    \subfloat[\centering Absolute difference between DNN and analytical solution]
    {\includegraphics[width=5.5cm]{Project3/figures/Tanh/-2_[100, 25]_diff.pdf}}%
    \caption{DNN with Tanh as activation function using 2 hidden layers of size $100$ and $25$ nodes.}%
    \label{fig:DNN_Tanh_3d}%
\end{figure}

\begin{figure}[H]
    \centering
    \subfloat[\centering Time step $t = 0.5$]{\includegraphics[width=8cm]{Project3/figures/Tanh/-2_[100, 25]_timestep_0.5.pdf}}
    \qquad
    \subfloat[\centering Time step $t = 1$]{\includegraphics[width=8cm]{Project3/figures/Tanh/-2_[100, 25]_timestep_1.0.pdf}}
    \caption{Difference between analytic and DNN solution for a single time step. DNN using Tanh with 2 layers of size $100$ and $25$.}
    \label{fig:diff_DNN_Sigmoid_single_step}
\end{figure}
